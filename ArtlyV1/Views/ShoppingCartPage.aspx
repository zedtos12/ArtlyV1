...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="cartWrapper d-flex align-content-center mt-5 mr-5 flex-column">
        ...
        <div class="cartContent d-flex align-items-center justify-content-around">
            <div class="cartItemListWrapper d-flex flex-column mt-3">
                ...
                <asp:Repeater ID="cartItemRepeater" runat="server">
                    <ItemTemplate>
                        <div class="cartItemWrapper d-flex align-items-center p-4">
                            ...
                            <div class="cartItemQuantity"><%#Eval("qty")%></div>
                        ...
                        <div class="cartItemSeparator ml-5"></div>
                    </ItemTemplate>
                </asp:Repeater>
            </div>
