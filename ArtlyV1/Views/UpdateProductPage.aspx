<%@ Page Title="Artly | Update your Product" Language="C#" MasterPageFile="~/Views/SellerDashboard.Master" AutoEventWireup="true" CodeBehind="UpdateProductPage.aspx.cs" Inherits="ArtlyV1.Views.UpdateProductPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     ...
     <div class="row">
         <p class="text-white font-weight-bold" style="font-size:1.5rem">Update Product</p>
     </div>
     <div class="row d-flex justify-content-center align-items-center mt-5">
         <div class="container d-flex">
             ...
             <div class="d-flex flex-column formAdd">
                 ...
                 <asp:Button ID="addProductBtn" runat="server" CssClass="btn btn-warning form-item p-2 mt-2 mb-4" Text="Update Product" OnClick="UpdateProductBtn_Click"/>
             </div>
         </div>
     </div>
 </div>
