            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12">
                            <label class="labels">State</label><input type="text" class="form-control" placeholder="enter state" value="">
                        </div>
                        <div class="col-md-12">
                            <label class="labels">Area</label><input type="text" class="form-control" placeholder="enter area" value="">
                        </div>
                        <div class="col-md-12">
            ...
            <div class="col-md-4 address-section">
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center address">
                        <h4 class="text-right">Profile Settings</h4>
                        <button class="btn btn-primary address-button" type="button">+ Address</button>
                    </div>
                    <br>
                    <div class="col-md-12">
                        <label class="labels">Address Name</label><input type="text" class="form-control" placeholder="insert address name" value="">
                    </div>
                    <br>
                    <div class="col-md-12">
